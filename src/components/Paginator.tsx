...
const Paginator = ({ page = 1, pageCount, total, isLoading, onClickPrev, onClickNext }: IPorps) => {
  return (
    <div className="flex flex-col items-center justify-center space-y-4">
      ...
      <div className="flex items-center justify-center">
        <button
          type="button"
          className="bg-gray-800 text-white rounded-l-md border-r border-gray-100 py-2 hover:bg-indigo-700 duration-300 hover:text-white px-3 disabled:bg-gray-400 disabled:hover:bg-gray-400 disabled:cursor-not-allowed"
