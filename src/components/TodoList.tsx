    ...
    <div className="space-y-1 ">
      ...
      {data.todos.length ? (
        data.todos.map((todo: ITodo) => (
          <div
            key={todo.id}
            className="flex sm:items-center gap-3 sm:justify-between flex-col sm:flex-row  hover:bg-gray-100 duration-300 p-3 rounded-md even:bg-gray-100"
          >
      ...
      <Modal
        ...
        description="Deleting this Todo will remove it permanently from your inventory. Any associted data, sales history, and other related information will also be deleted. Please make sure this is the intended action."
      >
